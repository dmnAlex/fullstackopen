...
describe('total likes', () => {
  ...
  test('of a bigger list is calculated rigt', () => {
...
describe('favorite blog', () => {
  test('of empty list is zero', () => {
    expect(listHelper.favoriteBlog(listWithZeroBlogs)).toEqual(null)
  })
  test('when list has only one blog, equals the likes of that', () => {
...
describe('most blogs', () => {
  test('of empty list is zero', () => {
    expect(listHelper.mostBlogs(listWithZeroBlogs)).toEqual(null)
  })
  test('when list has only one blog, equals the likes of that', () => {
...
describe('most likes', () => {
  test('of empty list is zero', () => {
    expect(listHelper.mostLikes(listWithZeroBlogs)).toEqual(null)
  })
  test('when list has only one blog, equals the likes of that', () => {
